...
/** Remove exactly telecode's hooks from `~/.claude/settings.json`; leave the user's own hooks (and the
 * rest of settings) intact. The mirror of {@link import('./hooks-install').installHooks}. */
